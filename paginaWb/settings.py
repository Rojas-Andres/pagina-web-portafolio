"""
Django settings for paginaWb project.
...
SECRET_KEY = 'django-insecure-o(yh_3+#(-7fza#*60lq$c-79l)rk5t-0zcxg=44@p+e21d=la'
...
WSGI_APPLICATION = 'paginaWb.wsgi.application'
